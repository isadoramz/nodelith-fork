...
describe('ContainerUnitTests', () => {
  ...
  it('should resolve with the same instance when lifecycle is not specified on the registration call', () => {
    const testContainer = new Container()
  ...
  it('should resolve with different instances when lifecycle is specified as transient on the registration call', () => {
    const testContainer = new Container()
